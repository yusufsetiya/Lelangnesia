...
class M_laporan extends CI_Model
{
    ...
    {
        $sql = "SELECT * FROM tb_pembayaran JOIN tb_barang ON tb_pembayaran.id_barang=tb_barang.id_barang JOIN tb_masyarakat ON tb_pembayaran.id_user=tb_masyarakat.id_user JOIN tb_lelang ON tb_lelang.id_lelang=tb_pembayaran.id_lelang WHERE tb_pembayaran.status_bayar ='sudah'";
    ...
    public function get_tanggal($mulai, $selesai)
    {
        $sql = "SELECT * FROM tb_pembayaran JOIN tb_barang ON tb_pembayaran.id_barang=tb_barang.id_barang JOIN tb_masyarakat ON tb_pembayaran.id_user=tb_masyarakat.id_user JOIN tb_lelang ON tb_lelang.id_lelang=tb_pembayaran.id_lelang WHERE tb_lelang.tgl_lelang = $mulai AND $selesai AND tb_pembayaran.status_bayar ='sudah'";
        return $this->db->query($sql)->result();
