                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php if ($byr->status_bayar == 'belum') { ?>
                                                <p class="badge badge-pill badge-danger">Belum</p>
                                            <?php } else { ?>
                                        ...
                                        <td>
                                            <?php if ($byr->batas_bayar <= $waktu) { ?>
                                                ...
                                                <form action="<?= base_url('C_pembayaran/batal_menangp'); ?>" method="POST">
                                                    <input type="hidden" name="id" value="<?= $byr->id_barang; ?>">
                                                    <input type="hidden" name="id_user" value="<?= $byr->id_user; ?>">
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <!-- <td>Laptop Asus</td> -->
                                        <td class="text-danger">Rp. <?= number_format($byr->harga_akhir); ?></td>
                                        <td><?= date('d F Y, H:i:s', strtotime($byr->waktu_bayar)); ?></td>
                                        <td>
                                            <?php if ($byr->status_bayar == 'belum') { ?>
                                                <p class="badge badge-pill badge-danger">Belum</p>
                                            <?php } else { ?>
